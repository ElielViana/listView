...
import 'package:listview/Controller/university_controller.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  TextEditingController name = TextEditingController(); //nameController
  @override
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        controller.universutyList(nameUniversity);
                      },
                      child: Icon(
  ...
  buildContainer(val) {
    return Container(
      child: FutureBuilder(
        future: controller.universutyList(val),
